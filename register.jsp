...
#error {
	...
	font-size: 25px;
	text-align: center;
	font-family: Ruluko, Gotham, "Helvetica Neue", Helvetica, Arial,
		sans-serif;
	position: absolute;
	top: 100px;
	left: 40%;
					...
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="register.php" method="post"
								...
								<div class="form-group">
									<label class="sr-only" for="confirm-form-passwordform-password">Confirm
										Password</label> <input type="password" name="confirmpassword"
										placeholder="Confirm Password..."
										class="form-password form-control" id="confirm-form-password">
								</div>
								<br> <input type="submit" class="btn" name="register"
									value="Sign up!">
							</form>
						</div>
					</div>
